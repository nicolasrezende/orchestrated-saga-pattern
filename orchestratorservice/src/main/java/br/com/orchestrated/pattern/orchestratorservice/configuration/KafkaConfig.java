package br.com.orchestrated.pattern.orchestratorservice.configuration;
...
public class KafkaConfig {
    ...
    public NewTopic orderValidationSuccessTopic() {
        return buildTopic(ORDER_VALIDATION_SUCCESS.getTopic());
    }

    @Bean
    public NewTopic orderValidationFailTopic() {
        return buildTopic(ORDER_VALIDATION_FAIL.getTopic());
    }

    @Bean
    public NewTopic orderRegisterSuccessTopic() {
        return buildTopic(ORDER_REGISTER_SUCCESS.getTopic());
    }

    @Bean
    public NewTopic orderRegisterFailTopic() {
        return buildTopic(ORDER_REGISTER_FAIL.getTopic());
    }

    @Bean
    public NewTopic notifyEndingTopic() { return buildTopic(NOTIFY_ENDING.getTopic()); }
